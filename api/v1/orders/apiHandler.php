<?php
   ...
   class ApiHandler 
   {
     ...
     public function createOrder()
     {
       ...
       $res = mysqli_query($connect->conn, "INSERT INTO orders(order_name,units,unit_price,order_status) VALUES ('$this->meal_name','$this->meal_units','$this->unit_price','$this->status')") or die("Error: ".mysqli_error($connect->conn));
