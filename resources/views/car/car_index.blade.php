...
<body>
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                <br />
                <h3 style="text-align:center; color:papayawhip;">VIEW ALL CARS</h3>
                ...
                <div style="text-align:right; margin:5px; color:white;">
                    <button class="btn btn-primary"><a href="{{route('car.create')}}" style="color:white;">ADD NEW CAR</a></button>
                </div>
                <div align="right">
